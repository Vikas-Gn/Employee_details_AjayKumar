...
app.use(cors({
  origin: [
    'http://3.111.197.208:8068', // Login Server
    'http://3.111.197.208:3051', // Employee Server
    'http://3.111.197.208:5500', // Live Server (Default)
    'http://127.0.0.1:5500', // Live Server (IP)
   // 'http://3.111.197.208:8037'  // Live Server (Alternate)
  ]
}));
